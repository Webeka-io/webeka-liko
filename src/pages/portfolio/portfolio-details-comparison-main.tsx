// src/components/portfolio/PortfolioDetailsComparisonMain.tsx
"use client";
...
// ⬇️ charge le composant uniquement côté client (pas de SSR)
...
export default function PortfolioDetailsComparisonMain() {
  useScrollSmooth();
