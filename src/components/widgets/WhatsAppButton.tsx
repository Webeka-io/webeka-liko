...
export default function WhatsAppButton({
        ...
        <>
          ...
          >
            ...
            <div className="p-3 border-top">
              <button onClick={handleOpenWhatsApp} className="btn btn-dark w-100 rounded-pill" disabled={!cleanPhone}>
                Lancer le chat
              </button>
            </div>
          </div>
  ...
  // Sur mobile : bouton WhatsApp + popup ; sur desktop : bouton email
  const content = isDesktop ? desktopContent : mobileContent;

  // Portal pour position:fixed fiable
