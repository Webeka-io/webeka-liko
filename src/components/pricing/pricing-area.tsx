                ...
                <ul className="tp-hero-3-category-3 my-4 text-start">
                  <li className="d-flex align-items-start mb-3">
                    ...
                    <div>
                      ...
                      <br />
                      <small className="text-muted">Design premium, adapté à votre activité</small>
                    </div>
                  </li>
                  <li className="d-flex align-items-start mb-3">
                    <CheckCircle className="h-4 w-4 text-green-600 mr-20px" />
                    <div>
                      ...
                      <br />
                      <small className="text-muted">Serveurs en Europe, certificat SSL inclus</small>
                    </div>
                  </li>
                  <li className="d-flex align-items-start mb-3">
                    <CheckCircle className="h-4 w-4 text-green-600 mr-20px" />
                    <div>
                      ...
                      <br />
                      <small className="text-muted">Mises à jour &amp; sauvegardes automatiques</small>
                    </div>
                  </li>
                  <li className="d-flex align-items-start mb-3">
                    <CheckCircle className="h-4 w-4 text-green-600 mr-20px" />
                  ...
                  <li className="d-flex align-items-start">
                    ...
                    <div>
                      ...
                      <br />
                      <small className="text-muted">Support téléphone &amp; e-mail</small>
                    </div>
                  </li>
                </ul>
