...
export function BounceArrowIcon2({ text = "Continuer", className = "" }: BounceArrowIconProps) {
  return (
    <div
      className={`d-flex flex-column align-items-center gap-2 bounce-arrow-wrapper1 ${className}`}
    >
